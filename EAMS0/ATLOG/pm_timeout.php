...
<body>
  <div class="header">Employee PM TIME-OUT</div>
  ...
  <div class="container">
    ...
    <div class="main">
      <div class="table-container">
        ...
        <div class="title">PM TIME-OUT</div>
            <!-- -->
            ...
            Webcam.upload( data_uri, 'saveimage_pm_out.php', function(code, text,Name) {
