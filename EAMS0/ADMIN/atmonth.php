...
<body>
    <div class="header"> <i class="fa-solid fa-bars" id="toggleSidebar" style="cursor: pointer;"></i> <h3>MONTHLY ATTENDANCE</h3></div>
        ...
        <div class="main">
            <div class="table-container">
                <div class="action-bar">
                    <div class="title">MONTHLY ATTENDANCE REPORT - <?php echo date('F Y'); ?></div>
                ...
                <table id="user-table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT * FROM atlog WHERE DATE_FORMAT(atlog_date, '%Y-%m') = '$currentMonth'";
