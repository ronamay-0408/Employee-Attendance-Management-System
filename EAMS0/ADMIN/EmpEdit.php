                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    <form action="db.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="firstline">
                                            ...
                                            <input type="text" name="code" value="<?= $employee['Code']; ?>" class="form-control" required>

                                            <label for="idNumber">ID_Number:</label>
                                            <input type="text" name="id_number" value="<?= $employee['IDNumber']; ?>" class="form-control">

                                            <label for="avatar">1x1Photo:</label>
                                            <input type="file" name="avatar" accept="image/*" class="form-control">
                                        </div>

                                        <label for="fullName">Full Name:</label>
                                        <input type="text" name="full_name" value="<?= $employee['FullName']; ?>" class="form-control" required>
                                        ...
                                        <div class="secondline">
                                            ...
                                            <input type="date" name="date_of_birth" value="<?= $employee['DateOfBirth']; ?>" class="form-control">
                                        </div>

                                        <label for="placeOfBirth">Place of Birth:</label>
                                        <input type="text" name="place_of_birth" value="<?= $employee['PlaceOfBirth']; ?>" class="form-control">

                                        <label for="employeePosition">Employee Position:</label>
                                        <input type="text" name="employee_position" value="<?= $employee['EmployeePosition']; ?>" class="form-control">
                                        ...
                                        <input type="date" name="date_of_hire" value="<?= $employee['DateOfHire']; ?>" class="form-control">

                                        <label for="employeeStatus">Employee Status:</label>
                                        <select id="employeeStatus" name="employee_status" class="form-control">
                                            <option value="Intern" <?php echo ($employee['EmployeeStatus'] == 'Intern') ? 'selected' : ''; ?>>Intern</option>
                                            <option value="Part Time" <?php echo ($employee['EmployeeStatus'] == 'Part Time') ? 'selected' : ''; ?>>Part Time</option>
                                            <option value="Full Time" <?php echo ($employee['EmployeeStatus'] == 'Full Time') ? 'selected' : ''; ?>>Full Time</option>
                                        </select>


                                        <div class="btn-container">
                                            <button type="submit" name="update_emp" class="btn"><h4 class="update">UPDATE</h4></button>
                                        </div>
                                    </form>
                                    <?php
                                } else {
